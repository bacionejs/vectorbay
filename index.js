...
const draw = () => {
    ...
    for (let i = 7; i <= 10; i++) {
        btns[i - 1].style.background = st[i] ? '#afa' : '';
    }
...
const tx = e => (e.offsetX - W / 2) / S;
const ty = e => (e.offsetY - H / 2) / S;
